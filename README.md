...
Launches Electron with a production instance of the application.<br>
Run `npm run build` first to generate the application bundle.
...
<span style="color:red">**Note: this is a one-way operation. Once you `eject`, you can’t go back!**</span>
